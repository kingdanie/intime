    ...
    <div className="h-screen w-full flex flex-col md:flex-row items-center justify-center">
      <div className="h-full w-1/2 py-5 px-10 flex justify-center overflow-y-auto">
        ...
        <div className="flex justify-between">
            <div className="flex flex-col gap-y-2 items-center rounded-lg  border-gray-300 bg-white" >
                <div className="flex p-5 shadow rounded-lg border">
        ...
        <form className="space-y-8 ">
          ...
          <button className="text-sm bg-yellow-400 text-black rounded-lg py-3 px-5">Sign up</button>
            </div>
        </form>
        </div>
      </div>
      <div className="w-1/2 h-full bg-purple-700 flex flex-col items-center justify-center">
        ...
        <button className="ring-white ring-2 shadow focus:border-white focus:ring-white  py-2 px-5 rounded-lg text-sm text-white">Login</button>
    </div>
    </div>
  );
}
